  ...
  execute: (): CommandResult => {
    try {
      ...
      try {
        ...
        systemLogger.warn('Could not reset command history in localStorage', {
          error: storageError
        });
      }
...
/**
 * Privacy command - Display the website's privacy policy
 */
export const privacyCommand: Command = {
  ...
  execute: (): CommandResult => {
    try {
      ...
      return {
        content: `<div class="privacy-policy"><h2>Privacy Policy</h2><p>Last Updated: March 11, 2025</p>
<h3>1. Introduction</h3>
<p>Welcome to the Privacy Policy for the &lt;programmer&gt;._ website. This document explains how we collect, use, and protect your information when you use our terminal-based portfolio website.</p>
<h3>2. Information We Collect</h3>
<p>We collect minimal information to provide and improve our services:</p>
<ul class="ml-4"><li>- <strong>Usage Data:</strong> Information on how you interact with our terminal interface, including commands entered and features used.</li><li>- <strong>Device Information:</strong> Browser type, operating system, and device specifications to optimize your experience.</li><li>- <strong>Cookies:</strong> Small text files stored on your device to remember your preferences and session information.</li></ul>
<h3>3. How We Use Your Information</h3>
<p>We use the collected information to:</p>
<ul class="ml-4"><li>- Provide and maintain our service</li><li>- Improve user experience</li><li>- Analyze usage patterns to enhance functionality</li><li>- Remember your preferences between sessions</li></ul>
...
<ul class="ml-4"><li>- Clear your locally stored data through browser controls</li><li>- Disable cookies in your browser settings</li><li>- Request information about what data is stored locally</li></ul>
...
/**
 * Terms command - Display the website's terms and conditions
 */
export const termsCommand: Command = {
  ...
  execute: (): CommandResult => {
    try {
      ...
      return {
        content: `<div class="terms-and-conditions"><h2>Terms and Conditions</h2>
...
<ul class="ml-4"><li>- Modify or copy the materials</li><li>- Use the materials for any commercial purpose</li><li>- Attempt to decompile or reverse engineer any software contained on the website</li><li>- Remove any copyright or other proprietary notations from the materials</li><li>- Transfer the materials to another person or "mirror" the materials on any other server</li></ul>
