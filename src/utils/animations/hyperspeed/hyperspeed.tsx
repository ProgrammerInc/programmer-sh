...
class App {
  ...
  clock: THREE.Clock;
  assets: Record<string, THREE.Texture | THREE.Material | THREE.BufferGeometry | THREE.Mesh>;
  disposed: boolean;
  road: Road;
  leftCarLights: CarLights;
  rightCarLights: CarLights;
  leftSticks: LightsSticks;
  fogUniforms: Record<string, { 
    value: number | boolean | THREE.Color | THREE.Vector2 | THREE.Vector3 | THREE.Vector4 
  }>;
  fovTarget: number;
