/**
 * ShootingStars Animation Module
 *
 * An animation component that creates shooting stars that traverse across the screen
 * with customizable colors and animation speeds.
 *
