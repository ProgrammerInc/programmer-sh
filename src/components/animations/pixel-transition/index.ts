/**
 * Pixel Transition animation component
 *
 * This component creates a pixel-based transition effect between two content elements,
 * using GSAP for animation and random pixel appearance/disappearance.
 *
