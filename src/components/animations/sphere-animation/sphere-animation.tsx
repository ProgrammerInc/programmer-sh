...
export const SphereAnimation = ({ className, colorScheme = 'default' }: SphereAnimationProps) => {
  ...
  const fitElementToParent = (el: SVGElement | HTMLElement, padding: number) => {
          ...
          <svg ref={sphereRef} className="sphere" viewBox="0 0 440 440" stroke="rgba(80,80,80,.35)">
            <defs>
              <linearGradient
                ...
                y2="15%"
              >
                <stop stopColor={colorSchemes[colorScheme].gradient[0]} offset="0%" />
                <stop stopColor={colorSchemes[colorScheme].gradient[1]} offset="50%" />
                <stop stopColor={colorSchemes[colorScheme].gradient[2]} offset="100%" />
              </linearGradient>
            </defs>
            <path
