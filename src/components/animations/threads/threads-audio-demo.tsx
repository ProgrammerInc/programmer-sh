...
export const ThreadsAudioDemo = () => {
  ...
  const handleSliderChange = useCallback(
    (event: React.ChangeEvent<HTMLInputElement>, type: keyof Omit<AudioData, 'frequencyData'>) => {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.controls}>
            ...
            <div className={styles.trackList}>
              {audioTracks.map(track => (
                <button
                  ...
                  onClick={() =>
                    isAudioFileActive && audioSrc === track.url ? stopFile() : startFile(track.url)
                  }
                >
        ...
        <div className={styles.info}>
          ...
          <p>
            Try using the microphone, playing an audio track, or manually controlling the audio
            parameters.
          </p>
        </div>
      </div>
