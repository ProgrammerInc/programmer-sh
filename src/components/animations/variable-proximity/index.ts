/**
 * Variable Proximity Animation Component
 *
 * An interactive text effect that responds to mouse proximity by changing variable font settings
 * for each letter based on the distance from the mouse cursor.
 *
