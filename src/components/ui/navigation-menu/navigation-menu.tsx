...
const NavigationMenu = memo(
  React.forwardRef<React.ElementRef<typeof NavigationMenuPrimitive.Root>, NavigationMenuProps>(
    ({ className, children, ...props }, ref) => {
      ...
      return (
        <NavigationMenuPrimitive.Root ref={ref} className={menuClassName} {...props}>
          {children}
 ...
 */
const NavigationMenuList = memo(
  React.forwardRef<React.ElementRef<typeof NavigationMenuPrimitive.List>, NavigationMenuListProps>(
    ({ className, ...props }, ref) => {
      const listClassName = useMemo(() => {
        return cn(styles['navigation-menu-list'], className);
      }, [className]);

      return <NavigationMenuPrimitive.List ref={ref} className={listClassName} {...props} />;
    }
  )
);
...
const NavigationMenuTrigger = memo(
  ...
  >(({ className, children, ...props }, ref) => {
    ...
    return (
      <NavigationMenuPrimitive.Trigger ref={ref} className={triggerClassName} {...props}>
        {children}{' '}
        <ChevronDown className={styles['navigation-menu-trigger-icon']} aria-hidden="true" />
 ...
 */
const NavigationMenuContent = memo(
  React.forwardRef<
  ...
  >(({ className, ...props }, ref) => {
    ...
    return <NavigationMenuPrimitive.Content ref={ref} className={contentClassName} {...props} />;
  })
);
 ...
 */
const NavigationMenuViewport = memo(
  React.forwardRef<
  ...
  >(({ className, ...props }, ref) => {
    ...
    return (
      <div className={styles['navigation-menu-viewport-container']}>
        <NavigationMenuPrimitive.Viewport className={viewportClassName} ref={ref} {...props} />
      </div>
    );
  })
);
 ...
 */
const NavigationMenuIndicator = memo(
  React.forwardRef<
  ...
  >(({ className, ...props }, ref) => {
    ...
    return (
      <NavigationMenuPrimitive.Indicator ref={ref} className={indicatorClassName} {...props}>
