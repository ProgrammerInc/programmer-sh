...
import { HistoryItem, TerminalHistoryProps, TerminalHistoryRef } from './terminal-history.types';
 ...
 * ```
 */
export const TerminalHistory = memo(forwardRef<TerminalHistoryRef, TerminalHistoryProps>(({ 
  history, 
  onCommandClick,
  prompt = '~$',
  animate = false,
      ...
      {history.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <div 
              className={styles['command-output']}
              aria-live="polite"
            >
              <TerminalResponse 
                response={result} 
