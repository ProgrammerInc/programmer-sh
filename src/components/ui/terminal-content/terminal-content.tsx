...
import {
  CommandLinkEventDetail,
  ProcessableElement,
  TerminalContentProps
} from './terminal-content.types';
...
export const TerminalContent = forwardRef<HTMLDivElement, TerminalContentProps>(
  ({ commandOutput, setScrollToBottom, isAwaitingAsync, asyncCommandName }, ref) => {
    ...
    return (
      <div ref={contentRef} className={styles['terminal-content']} role="log" aria-live="polite">
        {commandOutput &&
        ...
        {isAwaitingAsync && (
          <div className={styles['history-item']}>
            <TerminalLoading
              message={
                asyncCommandName ? `Processing ${asyncCommandName} command` : 'Processing command'
              }
              variant="dots"
            />
          </div>
