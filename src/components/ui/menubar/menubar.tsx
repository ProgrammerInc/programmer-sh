 ...
 */
const Menubar = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.Root>, MenubarProps>(
    ({ className, ...props }, ref) => {
      const menubarClassName = useMemo(() => {
        return cn(styles['menubar'], className);
      }, [className]);

      return <MenubarPrimitive.Root className={menubarClassName} ref={ref} {...props} />;
    }
  )
);
 ...
 */
const MenubarTrigger = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.Trigger>, MenubarTriggerProps>(
    ({ className, ...props }, ref) => {
      const triggerClassName = useMemo(() => {
        return cn(styles['menubar-trigger'], className);
      }, [className]);

      return <MenubarPrimitive.Trigger className={triggerClassName} ref={ref} {...props} />;
    }
  )
);
...
const MenubarSubTrigger = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.SubTrigger>, MenubarSubTriggerProps>(
    ({ className, inset, children, ...props }, ref) => {
      ...
      return (
        <MenubarPrimitive.SubTrigger className={subTriggerClassName} ref={ref} {...props}>
          {children}
...
const MenubarSubContent = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.SubContent>, MenubarSubContentProps>(
    ({ className, ...props }, ref) => {
      const subContentClassName = useMemo(() => {
        return cn(styles['menubar-sub-content'], className);
      }, [className]);

      return <MenubarPrimitive.SubContent className={subContentClassName} ref={ref} {...props} />;
    }
  )
);
 ...
 */
const MenubarContent = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.Content>, MenubarContentProps>(
...
const MenubarItem = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.Item>, MenubarItemProps>(
    ({ className, inset, ...props }, ref) => {
      const itemClassName = useMemo(() => {
        return cn(styles['menubar-item'], inset && styles['menubar-item-inset'], className);
      }, [className, inset]);

      return <MenubarPrimitive.Item className={itemClassName} ref={ref} {...props} />;
    }
  )
);
...
const MenubarRadioItem = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.RadioItem>, MenubarRadioItemProps>(
    ({ className, children, ...props }, ref) => {
      ...
      return (
        <MenubarPrimitive.RadioItem className={radioItemClassName} ref={ref} {...props}>
          <span className={styles['menubar-item-indicator']}>
            <MenubarPrimitive.ItemIndicator>
...
const MenubarLabel = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.Label>, MenubarLabelProps>(
    ({ className, inset, ...props }, ref) => {
      const labelClassName = useMemo(() => {
        return cn(styles['menubar-label'], inset && styles['menubar-label-inset'], className);
      }, [className, inset]);

      return <MenubarPrimitive.Label className={labelClassName} ref={ref} {...props} />;
    }
  )
);
...
const MenubarSeparator = memo(
  React.forwardRef<React.ElementRef<typeof MenubarPrimitive.Separator>, MenubarSeparatorProps>(
    ({ className, ...props }, ref) => {
      const separatorClassName = useMemo(() => {
        return cn(styles['menubar-separator'], className);
      }, [className]);

      return <MenubarPrimitive.Separator className={separatorClassName} ref={ref} {...props} />;
    }
  )
);
