 ...
 * ```
 */
export const CardHeader = memo(React.forwardRef<HTMLDivElement, CardHeaderProps>((
  { className, ...props }, ref
) => {
 ...
 * ```
 */
export const CardTitle = memo(React.forwardRef<HTMLHeadingElement, CardTitleProps>((
  { className, ...props }, ref
) => {
 ...
 * ```
 */
export const CardDescription = memo(React.forwardRef<HTMLParagraphElement, CardDescriptionProps>((
  { className, ...props }, ref
) => {
 ...
 * ```
 */
export const CardContent = memo(React.forwardRef<HTMLDivElement, CardContentProps>((
  { className, ...props }, ref
) => {
 ...
 * ```
 */
export const CardFooter = memo(React.forwardRef<HTMLDivElement, CardFooterProps>((
  { className, ...props }, ref
) => {
