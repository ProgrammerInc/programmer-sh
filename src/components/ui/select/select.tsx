 ...
 */
const SelectTrigger = memo(React.forwardRef<React.ElementRef<typeof SelectPrimitive.Trigger>, SelectTriggerProps>(
 ...
 */
const SelectScrollUpButton = memo(React.forwardRef<React.ElementRef<typeof SelectPrimitive.ScrollUpButton>, SelectScrollUpButtonProps>(
  ({ className, ...props }, ref) => {
    // Memoize the className calculation
 ...
 * - Automatically scrolls items into view when clicked
 */
const SelectScrollDownButton = memo(React.forwardRef<React.ElementRef<typeof SelectPrimitive.ScrollDownButton>, SelectScrollDownButtonProps>(
  ({ className, ...props }, ref) => {
    // Memoize the className calculation
    const scrollButtonClassName = useMemo(() => {
      return cn(styles['scroll-button'], className);
 ...
 */
const SelectContent = memo(React.forwardRef<React.ElementRef<typeof SelectPrimitive.Content>, SelectContentProps>(
 ...
 */
const SelectLabel = memo(React.forwardRef<React.ElementRef<typeof SelectPrimitive.Label>, SelectLabelProps>(
  ({ className, ...props }, ref) => {
    // Memoize the className calculation
 ...
 * - Provides focus styles for keyboard navigation
 */
const SelectItem = memo(React.forwardRef<React.ElementRef<typeof SelectPrimitive.Item>, SelectItemProps>(
  ({ className, children, ...props }, ref) => {
    // Memoize the className calculation
 ...
 */
const SelectSeparator = memo(React.forwardRef<React.ElementRef<typeof SelectPrimitive.Separator>, SelectSeparatorProps>(
  ({ className, ...props }, ref) => {
    // Memoize the className calculation
