...
import { CounterProps, DigitProps, NumberProps } from './counter.types';
  ...
  ({
    ...
    return (
      <div className={styles.container} style={containerStyle}>
        <div className={styles.counter} style={computedCounterStyle}>
          {places.map(place => (
            <Digit
              key={place}
              place={place}
        ...
        <div className={styles['gradient-container']}>
          <div className={styles['top-gradient']} style={computedTopGradientStyle} />
          <div className={styles['bottom-gradient']} style={computedBottomGradientStyle} />
        </div>
      </div>
    );
  }
