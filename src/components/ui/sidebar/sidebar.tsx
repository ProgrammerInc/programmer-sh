...
const SidebarRail = memo(
  React.forwardRef<HTMLButtonElement, SidebarRailProps>(({ className, ...props }, ref) => {
    const { toggleSidebar } = useSidebar();
...
const SidebarContent = memo(
  React.forwardRef<HTMLDivElement, SidebarContentProps>(({ className, ...props }, ref) => {
    return (
...
const SidebarHeader = memo(
  React.forwardRef<HTMLDivElement, SidebarHeaderProps>(({ className, ...props }, ref) => {
    return (
...
const SidebarFooter = memo(
  React.forwardRef<HTMLDivElement, SidebarFooterProps>(({ className, ...props }, ref) => {
    return (
...
const SidebarSearch = memo(
  React.forwardRef<HTMLDivElement, SidebarSearchProps>(
    ({ className, placeholder, onChange, defaultValue, value, onSubmit, ...props }, ref) => {
      ...
      return (
        <div ref={ref} data-sidebar="search" className={cn(styles.search, className)} {...props}>
...
const SidebarGroup = memo(
  React.forwardRef<HTMLDivElement, SidebarGroupProps>(
    ({ className, title, renderTitle, showTitle = true, children, ...props }, ref) => {
      ...
      return (
        <div ref={ref} data-sidebar="group" className={cn(styles.group, className)} {...props}>
          ...
          <div data-sidebar="group-content" className={styles.groupContent}>
            {React.Children.map(children, child => {
              if (React.isValidElement(child) && child.props['data-sidebar'] !== 'group-action') {
                return child;
              }
              return null;
            })}
      ...
      return (
        ...
        >
          {hasTitle && (
            ...
            >
              <div className={styles.menuTitleInner}>{renderTitle?.() || <span>{title}</span>}</div>
              <div className={styles.menuChevron} data-state={isOpen ? 'open' : 'closed'}>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
...
const SidebarMenuAction = memo(
  React.forwardRef<HTMLButtonElement, SidebarMenuActionProps>(
    ({ className, asChild = false, active = false, indicator = false, ...props }, ref) => {
      const Comp = asChild ? Slot : 'button';
