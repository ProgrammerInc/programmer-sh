...
export const BreadcrumbList = memo(
  React.forwardRef<HTMLOListElement, BreadcrumbListProps>(({ className, ...props }, ref) => {
...
export const BreadcrumbItem = memo(
  React.forwardRef<HTMLLIElement, BreadcrumbItemProps>(({ className, ...props }, ref) => {
 ...
 */
export const BreadcrumbPage = memo(
  React.forwardRef<HTMLSpanElement, BreadcrumbPageProps>(({ className, ...props }, ref) => {
...
export const BreadcrumbSeparator = memo(
  ({ children, className, ...props }: BreadcrumbSeparatorProps) => {
    ...
    return (
      <li role="presentation" aria-hidden="true" className={separatorClassName} {...props}>
 ...
 */
export const BreadcrumbEllipsis = memo(({ className, ...props }: BreadcrumbEllipsisProps) => {
  const ellipsisClassName = useMemo(() => {
    return cn(styles.ellipsis, className);
  }, [className]);

  return (
    <span role="presentation" aria-hidden="true" className={ellipsisClassName} {...props}>
