...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={cn(styles.label, labelClassName)}>{labelFormatter(value, payload)}</div>
        );
      }
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          ref={(el) => {
                            // Set indicator color via ref instead of inline style
                          ...
                          className={cn(
                            styles.indicator,
                            {
                              ...
                              [styles.indicatorDashedWithNestLabel]: nestLabel && indicator === 'dashed',
                            }
                          )}
                        />
                      )
                    ...
                    <div
                      className={cn(
                        ...
                        nestLabel ? styles.tooltipItemContentNestLabel : styles.tooltipItemContentNoNestLabel
                      )}
                    >
                      {nestLabel ? tooltipLabel : null}
        ...
        return (
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                ref={(el) => {
                  // Set background color via ref instead of inline style
                  if (el && item.color) {
                    el.style.setProperty('background-color', item.color);
                  }
                }}
